    ...
    */
    exec(cb) {
        process.nextTick(() => {
            ...
            (0, _map2.default)(this.cmds, (item, next) => {
                // ['set', 'foo', 'bar']
                const fnName = item.shift();
                // arg1 = 'foo', arg2 = 'bar', arg2 = undefined
                const [arg1, arg2, arg3] = item;
                if (arg1 !== undefined && arg2 !== undefined && arg3 !== undefined) {
                    return this.db[fnName](arg1, arg2, arg3, (err, res) => next(null, [err, res]));
                }
                if (arg1 !== undefined && arg2 !== undefined) {
                    return this.db[fnName](arg1, arg2, (err, res) => next(null, [err, res]));
                }
                return this.db[fnName](arg1, (err, res) => next(null, [err, res]));
            }, cb);
        });
    }
}
...
class Memory {
    ...
    */
    set(key, value, cb) {
        _assert2.default.strictEqual(typeof key, 'string');
        _assert2.default.strictEqual(typeof value === 'string' || typeof value === 'number', true);
        process.nextTick(() => {
    ...
    */
    get(key, cb) {
        _assert2.default.strictEqual(typeof key, 'string');
        process.nextTick(() => cb(null, this.data[key] === undefined ? null : this.data[key]));
    }
    ...
    */
    incr(key, cb) {
        ...
        process.nextTick(() => {
            ...
            if (Number.isNaN(val)) {
                throw new Error('Value at key cannot be represented as a ' + 'number');
            }
    ...
    */
    incrby(key, num, cb) {
        _assert2.default.strictEqual(typeof key, 'string');
        _assert2.default.strictEqual(typeof num, 'number');
        process.nextTick(() => {
            if (this.data[key] === undefined) {
                this.data[key] = 0;
            }
    ...
    */
    zadd(key, score, value, cb) {
        _assert2.default.strictEqual(typeof key, 'string');
        _assert2.default.strictEqual(typeof score, 'number');
        _assert2.default.strictEqual(typeof value === 'string' || typeof value === 'number', true);
    ...
    */
    zrangebyscore(key, min, max, cb) {
        _assert2.default.strictEqual(typeof key, 'string');
        _assert2.default.strictEqual(typeof min === 'number' || typeof min === 'string', true);
        _assert2.default.strictEqual(typeof max === 'number' || typeof max === 'string', true);
        ...
        process.nextTick(() => {
            ...
            const maxScore = min === '+inf' ? this.data[key][this.data[key].length - 1][0] : max;
            return cb(null, this.data[key].filter(item => item[0] >= minScore && item[0] <= maxScore).map(item => item[1]));
        });
    }
    ...
    */
    zrevrangebyscore(key, max, min, cb) {
        ...
        process.nextTick(() => {
            ...
            const minScore = min === '-inf' ? this.data[key][0][0] : min;
            const maxScore = min === '+inf' ? this.data[key][this.data[key].length][0] : max;
            ...
            return cb(null, cloneKeyData.filter(item => item[0] >= minScore && item[0] <= maxScore).map(item => item[1]));
        });
    }
