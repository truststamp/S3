...
exports.getMetricFromKey = getMetricFromKey;
exports.getStateKeys = getStateKeys;
exports.generateStateKey = generateStateKey;
exports.generateCounter = generateCounter;
// metric type schema
const stateKeys = {
...
function getSchemaPrefix(params, timestamp) {
    ...
    const prefix = timestamp ? `${service}:${level}:${timestamp}:${id}:` : `${service}:${level}:${id}:`;
    return prefix;
}
