...
var _validateMetric = require('./validateMetric');

var _validateMetric2 = _interopRequireDefault(_validateMetric);

var _validateTimeRange = require('./validateTimeRange');

var _validateTimeRange2 = _interopRequireDefault(_validateTimeRange);
 ...
 */
const keyMap = new Map([['buckets', _validateMetric2.default], ['accounts', _validateMetric2.default], ['users', _validateMetric2.default], ['service', _validateMetric2.default], ['timeRange', _validateTimeRange2.default]]);

/*
 * Map to link input with error to return
 */
const keyError = new Map([['buckets', _arsenal.errors.InvalidParameterValue], ['accounts', _arsenal.errors.InvalidParameterValue], ['users', _arsenal.errors.InvalidParameterValue], ['service', _arsenal.errors.InvalidParameterValue], ['timeRange', _arsenal.errors.InvalidParameterValue.customizeDescription('Timestamps must be one of the following intervals for any day/hour' + ' (mm:ss:SS) - start must be one of [00:00:000, 15:00:000, ' + '30:00:000, 45:00:000], end must be one of [14:59:999,' + ' 29:59:999, 44:59:999, 59:59:999].')]]);
...
class Validator {
    ...
    validate() {
        ...
        const valid = Object.keys(dict).every(item => {
            ...
            // if not boolean
            this[_error] = _arsenal.errors.WrongFormat;
            return false;
        });
